...
#         centroid = [e/12 for e in reduce(lambda a,b: (a[0]+b[0],a[1]+b[1],a[2]+b[2]), c)]
#         dists = sorted([manhattan3(p,centroid) for p in c])
#         fps.add(tuple(dists))
...
def part1():
    ...
    for i, pair in enumerate(pairs):
        ...
        # for f in rfp:
        #     if f in lfp:
            isect_fingerprint = isect.pop()
            found = [pair]
            print("Scanners", pair, "overlap")
            for lp in lps:
    ...
    # s = scanners[9]
    # fp, z_points = fingerprints(s)
    # print(len(fp))
    # for i, scanner in enumerate(scanners):
    #     if (i == 9): continue
    #     print(i)
    #     fpp, t_points = fingerprints(scanner)
    #     print(len(fpp))
    #     for f in fpp:
    #         if f in fp:
    #             print("Scanner ", i, "overlaps scanner 9")
    #             t_orig, z_orig = None, None
    #             for t_fp, points in t_points:
    #                 if t_fp == f:
    #                     t_orig = points
    #             for z_fp, points in z_points:
    #                 if z_fp == f:
    #                     z_orig = points
    #             print(t_orig)
    #             print(z_orig)
