...
def face(p, face_width):
    print("fac", p.real // face_width + 1j * (p.imag // face_width))
...
def part1():
    ...
    print("row", (pos.imag+1))
    print("col", (pos.real+1-50) )
    print("facing", facing)
    ...
    #     for x in range(150):
    #         if (x + y*1j) in moved:
    #             print(moved[x+y*1j], end="")
    #         elif (x + y*1j) in block:
    #             print(block[x+y*1j], end="")
    #         else:
    #             print(" ",end="")
    #     print()
